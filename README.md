...
1. A user submits a crime report.
2. The report is validated and sent to the backend.
3. The backend stores the report in the database.
4. The Hawkes Process model analyses recent reports.
5. Crime risk scores are generated.
6. A heatmap is produced from the predictions.
7. Authorised users can view the generated heatmap.
